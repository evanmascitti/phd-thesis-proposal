...
A fall-cone method for liquid limit determination was proposed by . This method is considered less operator-dependent and has been widely adopted internationally. Unfortunately most national standards use a different mass and cone angle which makes comparing results difficult. The British method BS 1377 @Holtz
...
Standard test methods typically pair the plastic and liquid limit tests. Established national standards include 
...
A recent survey by @Haigh2016 confirmed that the hardness and resilience of the rubber base varies widely across national specifications. Even within a rubber type (hard or soft), the coefficient of variation in rubber hardness was around 20%. Analytical solutions predict that a 20% deviation in base stiffness yields a change in the liquid limit of 2-3 units (i.e. % gravimetric water content). This value is similar to the standard deviation reported by an ASTM reproducibility study across 14 labs @ASTMD43182018, suggesting a large amount of inter-laboratory variability could be due simply to varition in the rubber base properties of the devices employed. 
