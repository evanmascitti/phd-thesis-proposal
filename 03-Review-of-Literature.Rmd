...
```{r lit-review-density-comparison, fig.cap="Dry bulk density values reported in research studies may be lower than those on extant professional playing surfaces", fig.scap="Dry density from published literature compared to author's data" }
...
```{r ball-indentation-release-angle, out.width="100%", fig.cap="A. A rigid soil surface produces a lower release angle, provided no imperfections are present in the surface. B. A surface with moderate stiffness encourages a longer impact duration, attenuating both spin and forward velocity.", fig.scap="Deformation of infield soil surface at ball impact", fig.align='center'}
knitr::include_graphics('images/illustrations/ball_indentation/ball_indentation.png')
```
...
Stable footing and predictable ball response comprise the requirements of an infield skin. Soil composition, density, and water content act together to govern the stiffness of the surface. Surface deformation attenuates linear and rotational kinetic energy of the ball. Existing studies on the infield skin have focused on construction/maintenance practices rather than mix design. 
...
### Effect of mixing multiple clays
