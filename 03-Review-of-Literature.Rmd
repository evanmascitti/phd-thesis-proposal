...
PSA has formed the basis for most discussions about infield mix (for example, @Schroder2009; -@Schroder2012). 
...
Instead, I have included this section to briefly outline possible pitfalls of using PSA to characterize infield soils. 
...
_Any_ attempt to classify soils into groups invokes a degree of arbitrariness. Pedantic debates about "silt-like" or "clay-like" behavior typify the murky business of classifying natural entities into discrete bins. 
...
```{r dumbleton-west-1666b-fig8-redraw, fig.cap='Data from Dumbleton and West (1966b) show the behavior of a clay mixture is not a simple linear interpolation between its components\' properties.', fig.scap='Atterberg limits of clay mixtures (from Dumbleton and West, 1966b)'}
