...
Toughness is a conspicuous feature of clay soils. This section describes the nature of toughness and attempts by researchers to measure or model this property.
...
knitr::include_graphics('images/illustrations/Lade_1998_Figure_7/Lade_1998_Figure_7.svg')
```
...
The geometrical calculations by @Lade1998 assume a single particle size for each mix component. The packing density $V_s$ of a two-component mixture is further increased when each individual component is well-graded. @Red1995 provided solutions for the optimum density of multi-phase mixtures when each has a log-normal particle size curve. 
...
Plasticity index has been positively correlated with optimum water content for compaction [@Sridharan2005; @Verma2019].
...
## Behavior of sand-clay mixtures in Atterberg limit tests

The Atterberg tests have been used to assess the behavior of sand-clay mixtures. 
The tests are intended to characterize fine-grained soils but their results can also reflect the nature of the coarse fraction.
This section summarizes research on the Atterberg limits of artificial soil mixtures. Two-component mixtures (sand with a single type of clay material) and three-component mixtures (sand with two forms of clay material) are both examined For brevity, in this section the term “clay” is used to mean the fine-grained soil component of the mixture and does not connote any particle size or mineralogical definition. 
...
__
@Sivapullaiah1985 showed that their linear law was not valid for mixtures of bentonite with kaolinite. The liquid limit of the mixture was always lower than would be expected from the linear law. This implies an interaction between the clay mineral particles. 
