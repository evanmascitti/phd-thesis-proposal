...
Sherwood's findings demonstrate that the Atterberg limits are quite repeatable provided the test is performed by an experienced operator with careful workmanship. 
Expected uncertainties associated with the tests are summarized in Figure \@ref(fig:sherwood-overall-comparison).
