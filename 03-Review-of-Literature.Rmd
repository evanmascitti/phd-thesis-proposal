...
```{r labor-per-area, fig.cap="The infield skin consumes the majority of labor input despite comprising only ~8% of the playing surface."}
# make some properly formatted labels for plotting purposes

area_colors <- tibble(type = c("Home plate", "Game mound/bullpen",
                                    "Infield skin", "Turf", "Warning track"),
                      hex= c("#694832", "#694832", "#694832", "#2c5f2d", "#8B0000" ) )
