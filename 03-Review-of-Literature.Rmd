...
```{r brosnan-survey-usda, eval= FALSE, echo=FALSE, fig.cap= 'Infield soils suyveyed by Brosnan (2008a)', dev='png', fig.width=5, fig.align='center'}
