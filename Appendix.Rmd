...
knitr::opts_chunk$set(echo = F, warning = F, message = F, out.width = '80%', fig.align = 'center', dpi = 72)
```
...
```{r labor-per-area-tab, include=T}
...
Plugging these values into Equations \@ref(eq:sand-clay-ratios-air-dry-sand-mass-appendix) and \@ref(eq:sand-clay-ratios-air-dry-clay-mass-appendix) gives an air-dry "sand" component mass of `r round((0.6-0.08)/(0.96-0.08)*50*1.002, 1)` kg and an air-dry "clay" component mass of `r round((1-((0.6-0.08)/(0.96-0.08)))*50*1.019, 1)` kg.
...
This document was rendered `r Sys.time()` using the following computational environment:
