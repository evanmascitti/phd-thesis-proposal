...
- Must choose mixtures carefully (represent broad spectrum of possibilities)
...
- Test range of particle sizes, mineralogy, AND plasticity/toughness
...
scr_kable <- scr_possible_vals %>% 
  kableExtra::kbl(align = 'lccc', format = 'html',
                  col.names = c(
                    'Sample name',
                    '% Silt-size',
                    '% Clay-size',
...
1. Sand % + SCR not sufficient to predict soil behavior
