...
An additional `r DescTools::RoundTo(x = wt_area_pct, multiple = 5)`% is occupied by the warning track, which alerts players that they are nearing the wall by its changing feel underfoot. 
...
knitr::include_graphics(
  path = here::here('figs', 'pdf', 'labor-per-area-plot.pdf')
)
```
...
knitr::include_graphics(
  here::here("figs", "pdf", "mlb-salaries-plots.pdf")
)
