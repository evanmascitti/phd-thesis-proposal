...
A majority of important plays occur on skinned areas (Figure \@ref(fig:batted-ball-density)), so the funds and effort devoted to maintaining them are disproportionately large (Figure \@ref(fig:labor-per-area)).
...
```{r batted-ball-density, fig.asp=1, fig.width=4, fig.align='center', fig.cap="Data from actual MLB contests support the intuition that most play occurs on the infield skin.", fig.scap="Concentration of play on the infield skin", fig.pos= 'pthb'}
...
```{r labor-per-area, fig.height=2.5, fig.cap= "The infield skin consumes a majority of inputs despite comprising less than 10 percent of the playing surface area.", fig.scap="Labor inputs for a professionally-managed infield skin", fig.pos='pthb'}
labor_per_area_plot
```
